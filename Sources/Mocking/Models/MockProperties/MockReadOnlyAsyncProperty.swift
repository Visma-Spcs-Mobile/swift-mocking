...
public final class MockReadOnlyAsyncProperty<Value> {
    ...
    /// invocation records for a read-only, async property.
    ///
    ...
    /// Creates a mock property, an async closure for invoking the mock
    ...
    /// - Parameter exposedPropertyDescription: The description of the mock's
    ///   exposed property.
    /// - Returns: A tuple containing a mock property, an async closure for
...
extension MockReadOnlyAsyncProperty: Sendable where Value: Sendable {
