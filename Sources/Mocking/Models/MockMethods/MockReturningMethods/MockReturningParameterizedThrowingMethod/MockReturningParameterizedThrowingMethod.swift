...
public final class MockReturningParameterizedThrowingMethod<
    Implementation: MockReturningParameterizedThrowingMethodImplementation
> {
    ...
    /// invocation records for a returning, parameterized, throwing method.
    ///
    ...
    ///
    /// ```swift
    /// private let __user = MockReturningParameterizedThrowingMethod<
    ///     UserImplementation
    /// >.makeMethod(
    ...
    /// )
    ///
    /// public var _user: MockReturningParameterizedThrowingMethod<
    ///     UserImplementation
    /// > {
    ///     self.__user.method
    /// }
    ...
    public static func makeMethod(
        ...
        method: MockReturningParameterizedThrowingMethod,
